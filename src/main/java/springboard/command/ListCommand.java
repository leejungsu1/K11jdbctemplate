...
/*
BbsCommandImpl를 구현했으므로 execute ()메소드는 반드시 
...
public class ListCommand implements BbsCommandImpl{
	...
	public void execute(Model model) {
		...
		//출력할 리스트 가져오기
		//ArrayList<SpringBbsDTO> listRows = dao.list(paramMap);->페이지처리 X
		ArrayList<SpringBbsDTO> listRows = dao.listPage(paramMap); //->페이지처리 O
